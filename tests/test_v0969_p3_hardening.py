...
checks = {
    ...
    # 5. 版本与文档自洽
    "版本串一致": 'VAULTHUB_ASSET_VERSION = "0.9.76"' in (ROOT / "index.html").read_text(encoding="utf-8")
        and 'VAULTHUB_SCRIPT_VERSION = "0.9.76"' in (ROOT / "web/js/01-state.js").read_text(encoding="utf-8"),
