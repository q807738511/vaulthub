...
check("T1 HTML 资源版本", 'VAULTHUB_ASSET_VERSION = "0.9.73"' in HTML)
check("T1 JS 脚本版本", 'VAULTHUB_SCRIPT_VERSION = "0.9.73"' in STATE)
...
check("T1 UI 版本角标", "v0.9.73" in HTML)
...
# ============ T4 文档一致性 ============
check("T4 Update Log v0.9.67 段", "# VaultHub 蜀鼠之家 v0.9.73" in UPDATELOG)
