...
# ---------------------------------------------------------------- 版本与发布引用
assert HTML.count("v0.9.78") >= 1, "关于与侧栏版本必须是 v0.9.78"
assert 'VAULTHUB_ASSET_VERSION = "0.9.78"' in HTML, "资源版本必须是 0.9.76"
assert 'VAULTHUB_SCRIPT_VERSION = "0.9.78"' in STATE, "脚本版本必须是 0.9.76"
