...
assert "walkMultiLibraryFiles(ctx, scanPaths, scanMaxDepth()" in GO or "walkMultiLibraryFiles(ctx, scanPaths, a.effectiveScanMaxDepth()" in GO, "扫描必须走多路径 walker（v0.9.56 / v0.9.80）"
...
# ---------------------------------------------------------------- 版本与发布引用
assert HTML.count("v0.9.80") >= 1, "关于与侧栏版本必须是 v0.9.80"
assert 'VAULTHUB_ASSET_VERSION = "0.9.80"' in HTML, "资源版本必须是 0.9.80"
assert 'VAULTHUB_SCRIPT_VERSION = "0.9.80"' in STATE, "脚本版本必须是 0.9.80"
