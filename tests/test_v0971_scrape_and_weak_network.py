...
# ============ 版本一致性 ============
check("本版版本", 'VAULTHUB_ASSET_VERSION = "0.9.71"' in HTML and 'VAULTHUB_SCRIPT_VERSION = "0.9.71"' in STATE)
check("资源缓存串", HTML.count("?v=0.9.71") >= 7, f"实际 {HTML.count('?v=0.9.71')}")
check("UI 版本角标", "v0.9.71" in HTML and HTML.count("v0.9.71") >= 2)
