...
# ============ 版本一致性 ============
check("本版版本", 'VAULTHUB_ASSET_VERSION = "0.9.80"' in HTML and 'VAULTHUB_SCRIPT_VERSION = "0.9.80"' in STATE)
check("资源缓存串", HTML.count("?v=0.9.80") >= 7, f"实际 {HTML.count('?v=0.9.80')}")
check("UI 版本角标", "0.9.80" in HTML)
...
# v0.9.80：仓库主在 e97c23f 里精简 README，删掉了「弱网与远程访问」小节（细则以
