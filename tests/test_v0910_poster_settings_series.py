...
# 4. v0.9.41 发布引用与增量同步工作流。
assert 'v0.9.41' in HTML
assert 'ghcr.io/q807738511/vaulthub:v0.9.41' in COMPOSE
...
print('PASS: v0.9.41 poster hero, sidebar settings and Plex/Emby-style series grouping')
