...
# 4. v0.9.13 发布引用与 Docker Hub 同步优先标签。
assert 'v0.9.13' in HTML
assert 'ghcr.io/q807738511/vaulthub:v0.9.13' in COMPOSE
assert 'PRIORITY_TAG=v0.9.13' in SYNC
print('PASS: v0.9.13 poster hero, sidebar settings and Plex/Emby-style series grouping')
...
# v0.9.13：剧集库必须一次聚合整部剧，不能被 50 条一页的分页切成半截
