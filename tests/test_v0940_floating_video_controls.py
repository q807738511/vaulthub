...
check(HTML.count("v0.9.68") >= 2, "关于与侧栏版本必须是 v0.9.66")
check('VAULTHUB_ASSET_VERSION = "0.9.68"' in HTML, "资源版本必须是 0.9.66")
check('VAULTHUB_SCRIPT_VERSION = "0.9.68"' in STATE, "脚本版本必须是 0.9.66")
...
if failures:
    print(f"FAIL: {len(failures)} 项 v0.9.68 契约未满足")
