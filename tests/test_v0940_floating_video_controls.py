...
check(HTML.count("v0.9.73") >= 2, "关于与侧栏版本必须是 v0.9.73")
check('VAULTHUB_ASSET_VERSION = "0.9.73"' in HTML, "资源版本必须是 0.9.73")
check('VAULTHUB_SCRIPT_VERSION = "0.9.73"' in STATE, "脚本版本必须是 0.9.73")
