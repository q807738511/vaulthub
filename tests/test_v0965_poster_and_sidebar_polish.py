#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v0.9.65 海报标签编辑按钮清理 · 播放器海报自适应 · 移动端侧栏滚动 · 磨砂清晰度契约测试。"""
...
checks = {
    ...
    "折叠后左缘归零": "body.sidebar-hidden .audio-fullscreen-overlay { left:0; }" in CSS,
...
print("PASS: v0.9.65 编辑入口合并、海报自适应与居中、遮罩跟随侧栏、移动端侧栏滚动、85% 磨砂契约通过")
