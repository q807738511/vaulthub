...
const windowStub = {
  ...
  innerWidth: 1440, innerHeight: 900, VAULTHUB_ASSET_VERSION: "0.9.79"
};
...
sandbox.saveAudioQualityChoice = (v) => { /* v0.9.79 移除，保留桩避免历史测试其余引用报错 */ };
sandbox.cycleAudioQuality = () => { /* v0.9.79 移除 */ };
...
ok("音质始终由后台判定（v0.9.79 移除手动选择，恒为 auto）",
