#!/usr/bin/env python3
"""VaultHub v0.9.53 deployment contracts: latest-follow + optional env file.
...
Asserts against the real repo files:
  ...
  * the v0.9.53 release notes exist and frontend/JS carry version 0.9.53.
"""
...
release = (ROOT / ".github/RELEASE_NOTES_0.9.53.md").read_text(encoding="utf-8")
...
def test_version_strings():
    ...
    assert 'VAULTHUB_SCRIPT_VERSION = "0.9.53"' in state
    assert "VaultHub v0.9.53" in release
