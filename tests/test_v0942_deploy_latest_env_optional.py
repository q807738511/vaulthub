...
release = (ROOT / ".github/RELEASE_NOTES_0.9.61.md").read_text(encoding="utf-8")
...
def test_version_strings():
    assert "0.9.61" in index
    assert 'VAULTHUB_SCRIPT_VERSION = "0.9.61"' in state
    assert "VaultHub 蜀鼠之家 v0.9.61" in release
