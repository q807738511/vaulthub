...
release = (ROOT / ".github/RELEASE_NOTES_0.9.58.md").read_text(encoding="utf-8")
...
def test_version_strings():
    assert "0.9.58" in index
    assert 'VAULTHUB_SCRIPT_VERSION = "0.9.58"' in state
    assert "VaultHub v0.9.58" in release
