#!/usr/bin/env python3
"""VaultHub v0.9.56 deployment contracts: latest-follow + optional env file.
...
Asserts against the real repo files:
  ...
  * the v0.9.56 release notes exist and frontend/JS carry version 0.9.56.
"""
...
release = (ROOT / ".github/RELEASE_NOTES_0.9.64.md").read_text(encoding="utf-8")
...
def test_version_strings():
    assert "0.9.64" in index
    assert 'VAULTHUB_SCRIPT_VERSION = "0.9.64"' in state
    assert "VaultHub 蜀鼠之家 v0.9.64" in release
