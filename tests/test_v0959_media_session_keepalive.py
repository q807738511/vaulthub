...
checks = {
    "版本资源": 'VAULTHUB_ASSET_VERSION = "0.9.79"' in HTML,
    "脚本版本": 'VAULTHUB_SCRIPT_VERSION = "0.9.79"' in STATE,
    "静态缓存串": HTML.count("?v=0.9.79") >= 7,
    ...
    "加载 zoom 脚本": '<script src="/web/js/03-audio-zoom.js?v=0.9.79"></script>' in HTML,
    "发布说明": "VaultHub 蜀鼠之家 v0.9.69" in NOTES and "非阻塞" in NOTES,
    "更新日志": "VaultHub 蜀鼠之家 v0.9.79" in LOG and "遮罩左缘" in LOG,
}
