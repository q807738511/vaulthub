...
# ---------------------------------------------------------------- 版本与发布引用
assert "v0.9.65" in HTML and HTML.count("v0.9.65") >= 2, "关于与侧栏版本必须是 v0.9.65"
assert 'VAULTHUB_ASSET_VERSION = "0.9.65"' in HTML, "资源版本必须是 0.9.65"
assert 'VAULTHUB_SCRIPT_VERSION = "0.9.65"' in STATE, "脚本版本必须是 0.9.65"
