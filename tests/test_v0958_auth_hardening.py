...
# ---------------------------------------------------------------- 版本与发布
check("版本资源", 'VAULTHUB_ASSET_VERSION = "0.9.58"' in HTML)
check("脚本版本", 'VAULTHUB_SCRIPT_VERSION = "0.9.58"' in STATE)
check("缓存串", HTML.count("?v=0.9.58") >= 6)
check("UI 角标", "v0.9.58 · Secure First Boot" in HTML)
check("release notes", NOTES != "" and "VaultHub v0.9.58" in NOTES and "强制改密" in NOTES)
