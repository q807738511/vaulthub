...
# ---------------------------------------------------------------- 版本与发布
check("版本资源", 'VAULTHUB_ASSET_VERSION = "0.9.69"' in HTML)
check("脚本版本", 'VAULTHUB_SCRIPT_VERSION = "0.9.69"' in STATE)
check("缓存串", HTML.count("?v=0.9.69") >= 6)
check("UI 当前版本角标", "v0.9.69 · Hardening R2" in HTML)
