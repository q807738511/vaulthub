# VaultHub 蜀鼠之家 v0.9.52：播放器图标修复 · 音频播放器 Apple 化 · 媒体库多存储路径 · 剧集信息读取修复

v0.9.52 针对 v0.9.51 上线后反馈的四类问题（视频悬浮控制栏图标显示异常、音频播放器图标未随 Apple 皮肤、单媒体库只能挂一个存储路径、剧集海报/单集截图信息读取失败）进行修复与增强：
