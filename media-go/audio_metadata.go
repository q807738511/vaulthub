...
/* v0.9.53：音乐刮削主源换成 iTunes Search API —— 无需注册/密钥、返回极简 JSON、
...
/* v0.9.53 入口：iTunes 主源，失败回落 MusicBrainz（英文/小众曲目）。 */
...
func (a *App) scrapeAudioItunes(ctx context.Context, title, artist string) (audioScrapeResult, bool) {
	...
	for _, country := range itunesCountryOrder {
		...
		req.Header.Set("User-Agent", "VaultHub/0.9.53 (https://github.com/q807738511/vaulthub)")
